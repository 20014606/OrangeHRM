...
def test_setup():
    ...
    service = Service(executable_path=ChromeDriverManager(latest_release_url='https://googlechromelabs.github.io/chrome-for-testing/last-known-good-versions-with-downloads.json', driver_version="126.0.6478.126").install())
    options = Options()
